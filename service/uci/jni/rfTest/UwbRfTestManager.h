...
typedef struct {
  ...
  uint16_t aoa_azimuth;             //< AoA Azimuth in degrees and it is signed value in Q9.7 format
  uint16_t aoa_elevation;           //< AoA Elevation  in degrees and it is signed value in Q9.7 format
...
typedef struct {
  ...
  uint16_t rx_done_ts_frac;         //< Fractional part of timestamp in 1/(128 * 499.2MHz) ticks resolution
  uint16_t aoa_azimuth;             //< AoA Azimuth in degrees and it is signed value in Q9.7 format
  uint16_t aoa_elevation;           //< AoA Elevation  in degrees and it is signed value in Q9.7 format
