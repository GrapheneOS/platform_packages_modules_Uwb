...
public class ConfigParam {
    ...
    // CCC
    //OpenParams
    public static final int RANGING_PROTOCOL_VER = 0xA3;
    public static final int UWB_CONFIG_ID = 0xA4;
    public static final int PULSESHAPE_COMBO = 0xA5;
    public static final int URSK_TTL = 0xA6;
    //StartedParams
