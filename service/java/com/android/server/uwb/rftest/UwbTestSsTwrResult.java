 ...
 */
public class UwbTestSsTwrResult implements RfNotificationEvent {
    private int mStatus;
    private long mMeasurement;
    private byte[] mRawNotificationData;

    public UwbTestSsTwrResult(int status, long measurement, byte[] rawNotificationData) {
        this.mStatus = status;
    ...
    public int getOperationType() {
        return RfTestParams.TEST_SS_TWR;
    }

    @Override
    public PersistableBundle toBundle() {
        RfTestSsTwrResult.Builder builder = new RfTestSsTwrResult.Builder(getOperationType(),
                mStatus, mMeasurement, mRawNotificationData);
        return builder.build().toBundle();
    }

    @Override
    public String toString() {
        return "UwbTestSsTwrResult { "
                + " Status = " + mStatus
