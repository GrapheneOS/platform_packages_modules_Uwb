...
class RangingTest(uwb_base_test.UwbBaseTest):
  ...
  def _get_uci_version(
      self, device: uwb_ranging_decorator.UwbRangingDecorator):
    """Gets uci version from device.
  ...
  def _verify_add_controlee_when_opened_ranging_with_no_controlee(
    ...
    if sub_session_id is not None:
        initiator_params.update(sub_session_id=sub_session_id)
        responder_params.update(sub_session_id=sub_session_id)
    if sub_session_key is not None:
        initiator_params.update(sub_session_key=sub_session_key)
        responder_params.update(sub_session_key=sub_session_key)
    responder.open_fira_ranging(responder_params)
    responder.start_fira_ranging()
  ...
  def test_ranging_nearby_share_profile_p_sts_add_controlee(self):
    ...
    self._verify_add_controlee_when_opened_ranging_with_no_controlee(
        self.initiator, self.responder, initiator_params, responder_params,
  ...
  @ApiTest(apis=[
      'android.uwb.RangingSession#createLogicalLink(android.uwb.LogicalLinkCreationParams)',
      'android.uwb.LogicalLinkCreationParams.Builder(int, android.uwb.UwbAddress)',
      'android.uwb.RangingSession#getLogicalLinkCreationParams(int)',
      'android.uwb.RangingSession#queryLogicalLinkMaxDataSizeBytes(int)',
      'android.uwb.RangingSession#closeLogicalLink(int)',
      'android.uwb.LogicalLinkCreationParams#getLogicalLinkClassLength()',
      'android.uwb.LogicalLinkCreationParams#getLinkLayerModeSelector()',
      'android.uwb.RangingSession#createLogicalLink(android.uwb.LogicalLinkCreationParams)',
      'android.uwb.LogicalLinkCreationParams.Builder#setLogicalLinkClassLength(int)',
      'android.uwb.LogicalLinkConnectionRequest.Builder#LogicalLinkConnectionRequest.Builder(int, int, android.uwb.UwbAddress)',
      'android.uwb.LogicalLinkConnectionRequest.Builder#build()',
      'android.uwb.LogicalLinkConnectionRequest#getSourceAddress()',
      'android.uwb.LogicalLinkCreationParams#getDestinationAddress()',
      'android.uwb.LogicalLinkConnectionRequest#getConnectId()',
      'android.uwb.LogicalLinkConnectionRequest#getLinkLayerModeSelector()',
      'android.uwb.LogicalLinkConnectionParams.Builder#setReceiveWindowSize(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setRepeatCountMax(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setSourcePort(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setMaxLinkLayerSduSize(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setTransmitWindowSize(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setDestinationPort(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#build()',
      'android.uwb.LogicalLinkConnectionParams.Builder#setLinkTimeout(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#setMaxLinkLayerPduSize(int)',
      'android.uwb.LogicalLinkConnectionParams.Builder#LogicalLinkConnectionParams.Builder(int, int)',
      'android.uwb.LogicalLinkConnectionParams#hasTransmitWindowSize()',
      'android.uwb.LogicalLinkConnectionParams#hasSourcePort()',
      'android.uwb.LogicalLinkConnectionParams#hasRepeatCountMax()',
      'android.uwb.LogicalLinkConnectionParams#hasDestinationPort()',
      'android.uwb.LogicalLinkConnectionParams#hasMaxLinkLayerSduSize()',
      'android.uwb.LogicalLinkConnectionParams#getDestinationPort()',
      'android.uwb.LogicalLinkConnectionParams#getLinkTimeout()',
      'android.uwb.LogicalLinkConnectionParams#getReceiveWindowSize()',
      'android.uwb.LogicalLinkConnectionParams#getSourcePort()',
      'android.uwb.LogicalLinkConnectionParams#getMaxLinkLayerSduSize()',
      'android.uwb.LogicalLinkConnectionParams#hasReceiveWindowSize()',
      'android.uwb.LogicalLinkConnectionParams#hasLinkTimeout()',
      'android.uwb.LogicalLinkConnectionParams#getRepeatCountMax()',
      'android.uwb.LogicalLinkConnectionParams#hasMaxLinkLayerPduSize()',
      'android.uwb.LogicalLinkConnectionParams#getStatus()',
      'android.uwb.LogicalLinkConnectionParams#getTransmitWindowSize()',
      'android.uwb.LogicalLinkConnectionParams#getMaxLinkLayerPduSize()',
  ])
