...
public class RoleSelectionFragment extends Fragment {
    ...
    private Button mButtonResponder;
    ...
    public View onCreateView(
        ...
        mButtonResponder = (Button) root.findViewById(R.id.button_responder);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mButtonResponder.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        NavHostFragment.findNavController(RoleSelectionFragment.this)
                                .navigate(R.id.action_RoleSelectionFragment_to_ResponderFragment);
                    }
                });
    }
