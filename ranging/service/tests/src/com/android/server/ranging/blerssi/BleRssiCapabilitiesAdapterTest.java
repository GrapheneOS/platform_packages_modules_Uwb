...
public class BleRssiCapabilitiesAdapterTest {
    ...
    public void setUp() {
        ...
        RangingInjector injector = mock(RangingInjector.class);
        when(injector.isRangingTechnologyEnabled(eq(RangingTechnology.RSSI))).thenReturn(true);
        RangingInjector.setInstance(injector);
