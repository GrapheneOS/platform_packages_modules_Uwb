...
@SmallTest
public class RttStationCapabilitiesAdapterTest {
    @Mock
    ...
    private RttStationCapabilitiesAdapter mAdapter;
    ...
    public void setUp() {
        ...
        when(mMockRangingInjector.isRangingTechnologyEnabled(RangingTechnology.RTT_STATION))
                .thenReturn(true);
        ...
        mAdapter = new RttStationCapabilitiesAdapter(mMockContext, mMockListener);
    }
